...
def test_check_carousel_item(browser, base_url):
    ...
    wait.until(
        method=EC.visibility_of_element_located((By.ID, "carousel-banner-0")),
        message="Не появился элемент (carousel-banner-0)",
    )
...
def test_image_from_carousel(browser, base_url):
    ...
    carousel_item = wait.until(
        method=EC.visibility_of_element_located(
            (By.XPATH, '//*[@id="carousel-banner-0"]/div[2]/div[2]/div/div')
        ),
...
def test_image_starbacks_coffie(browser, base_url):
    ...
    image_starbacks_coffie = wait.until(
        method=EC.visibility_of_element_located(
            (By.XPATH, '//*[@id="carousel-banner-1"]/div[2]/div[2]/div/div[5]/img')
        ),
...
def test_image_from_carousel_on_click(browser, base_url):
    ...
    element = wait.until(
        method=EC.presence_of_element_located(
            (By.XPATH, '//*[@id="carousel-banner-1"]/div[1]/button[2]')
        ),
    ...
    browser.find_element(
        By.XPATH, '//*[@id="carousel-banner-1"]/div[1]/button[1]'
    ).click()
    image = wait.until(
        method=EC.visibility_of_element_located(
            (By.XPATH, '//*[@id="carousel-banner-1"]/div[2]/div[1]/div/div[3]/img')
        ),
...
def test_right_button_from_carousel(browser, base_url):
    ...
    right_button = wait.until(
        method=EC.visibility_of_element_located(
            (By.XPATH, '//*[@id="carousel-banner-1"]/button[2]')
        ),
