...
#
# # 1 Поиск меню
# def test_check_categories (browser, login_page_url):
...
# def test_check_shop_cart_of_first_product (browser, login_page_url):
#     browser.get(login_page_url)
#     wait = WebDriverWait(browser, 3, poll_frequency=1)
...
# def test_check_my_account(browser, catalog_page_url):
...
# def test__check_product_name(browser, login_page_url):
#     browser.get(login_page_url)
#     # Клик по пункту меню
#     time.sleep(1)
